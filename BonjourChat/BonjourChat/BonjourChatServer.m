...
{
	self = [super initWithBonjourType:@"_BonjourVideoChat._tcp."];
...
{
    NSString *ipString = [__AppDelegate ipAddress];
    
	self.TXTRecord = @{@"ipAdress" : ipString,
                       @"ID" : [_identifier dataUsingEncoding:NSUTF8StringEncoding],
                       @"RoomName" : [_roomName dataUsingEncoding:NSUTF8StringEncoding]};
}
